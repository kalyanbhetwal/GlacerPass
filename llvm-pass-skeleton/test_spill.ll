...
define i32 @complex_function(i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d) local_unnamed_addr #0 {
entry:
  %add = add nsw i32 %b, %a
  %add1 = add nsw i32 %d, %c
  %mul = mul nsw i32 %add1, %add
  %sub = sub nsw i32 %a, %b
  %sub2 = sub nsw i32 %c, %d
  %mul3 = mul nsw i32 %sub2, %sub
  %add4 = add nsw i32 %mul, %mul3
  %sub5 = add i32 %add4, %add
  %add6 = sub i32 %sub5, %add1
  %mul7 = shl nsw i32 %add6, 1
  %add8 = add i32 %mul3, %mul
