...
echo "=========================================="
echo ""
echo "✅ discard_func:   Uses r12, r13 (within R10-R13)"
echo "✅ normal_func:    Uses r14, r15 (avoids R10-R13)"
echo "✅ discard_func2:  Uses r11, r12, r13 (within R10-R13)"
echo "✅ normal_func2:   Uses r9, r14, r15 (avoids R10-R13)"
echo ""
echo "Register allocator successfully partitions registers!"
echo "  - Discard functions use only R10-R13"
echo "  - Normal functions avoid R10-R13"
