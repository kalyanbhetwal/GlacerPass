...
define noundef range(i32 0, -1) i32 @test(i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d, i32 noundef %e) local_unnamed_addr #0 {
entry:
  %reass.add = add i32 %b, %a
  %reass.add18 = add i32 %reass.add, %c
  %reass.add19 = add i32 %reass.add18, %d
  %reass.add20 = add i32 %reass.add19, %e
  %reass.mul = shl i32 %reass.add20, 1
  ret i32 %reass.mul
}
